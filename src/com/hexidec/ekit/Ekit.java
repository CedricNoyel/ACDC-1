...
public class Ekit extends JFrame implements WindowListener
{
	...
	private void createEkitTxtfield() {
		this.getContentPane().add(ekitCore.getToolBar(true));
		this.getContentPane().add(ekitCore);
	}
	...
	private void createPanelAuthor() 
	{
		...
		lblAuthor = new JLabel("Auteur", SwingConstants.CENTER);
	...
	{
		JPanel panel = new JPanel();
		lblTitle = new JLabel("Ajouter une news - stack.inria.fr", JLabel.CENTER);
	...
	{
		JPanel panel = new JPanel();
		btnPreview = new JButton("Voir l'aperçu");
		btnValid = new JButton("Publier");
